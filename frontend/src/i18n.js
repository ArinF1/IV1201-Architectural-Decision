/**
 * @fileoverview i18n setup with English and Swedish translations.
 * @module i18n
 */
      ...
      en: {
        translation: {
          ...
          applicationList: {
            ...
            reject: 'Reject',
            submitted: 'Submitted',
            loadingApplications: 'Failed to load applications',
            updateStatusError: 'Failed to update status',
            sortStatus: 'Status (unhandled first)',
            sortExperience: 'Total Experience (most first)',
            filterStatus: 'Status',
            filterCompetence: 'Competence',
            allCompetences: 'All competences',
            filterMinExperience: 'Min. Experience (yrs)',
            filterAvailability: 'Available between',
            ...
            noCompetencies: 'No competencies listed',
            noAvailability: 'No availability periods listed',
            personNumber: 'Person Number'
          },
          registration: {
            title: 'Register',
      ...
      sv: {
        translation: {
          ...
          applicationList: {
            ...
            reject: 'Avvisa',
            submitted: 'Inskickad',
            loadingApplications: 'Misslyckades att ladda ansökningar',
            updateStatusError: 'Misslyckades att uppdatera status',
            sortStatus: 'Status (ohanterad först)',
            sortExperience: 'Mest erfarenhet (högst först)',
            filterStatus: 'Status',
            filterCompetence: 'Kompetens',
            allCompetences: 'Alla kompetenser',
            filterMinExperience: 'Min. erfarenhet (år)',
            filterAvailability: 'Tillgänglig mellan',
            clearFilters: 'Rensa filter',
            markUnhandled: 'Markera ohanterad',
            prev: 'Föregående',
            next: 'Nästa',
            pageLabel: 'Sida',
            ofPages: 'av',
            loading: 'Laddar ansökningar...',
            noCompetencies: 'Inga kompetenser listade',
            noAvailability: 'Inga tillgänglighetsperioder listade',
            personNumber: 'Personnummer'
          },
          registration: {
            title: 'Registrera',
